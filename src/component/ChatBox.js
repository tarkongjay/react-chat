  ...
  return (
    <div  style={{display:'flex', justifyContent:'flex-start' , flexDirection:'row'}} >
            ...
            src={<Image
                ...
                />}
            />
            <p style={{padding:10 , backgroundColor:'gray', borderRadius: 10 , maxWidth: "60%" , color: "white" }} >
    ...
    return (
      <div  style={{display:'flex', paddingRight:10  ,justifyContent:'flex-end' , flexDirection:'row'}} >
              ...
              src={<Image
                  ...
                  />}
              />
              <p style={{padding:10 , backgroundColor:'#dcf8c6', borderRadius: 10 , maxWidth: "60%" ,color: 'black'}} >
                  <strong style={{fontSize:13}} >
                         {user} 
                  </strong> <br></br>
                  {message}
